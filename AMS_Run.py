...
window = tk.Tk()
window.title("Aman's-Face Recognition Based Attendance Management System")
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'attndnc.csv'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\User\OneDrive\Desktop\nsnsnns\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            with open('C:/Users/User/OneDrive/Desktop/nsnsnns/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    recognizer.load("C:/Users/User/OneDrive/Desktop/nsnsnns/Face-Recognition-Attendance-System-main/TrainingImageLabel/Trainner.yml")
                except:
                ...
                df = pd.read_csv("C:/Users/User/OneDrive/Desktop/nsnsnns/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv")
                cam = cv2.VideoCapture(0)
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/User/OneDrive/Desktop/nsnsnns/Face-Recognition-Attendance-System-main/StudentDetails' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,":/Users/User/OneDrive/Desktop/nsnsnns/Face-Recognition-Attendance-System-main/StudentDetails/-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'aman':
            if password == 'aman123':
                ...
                cs = 'C:/Users/User/OneDrive/Desktop/nsnsnns/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
